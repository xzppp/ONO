...
def main():
    ...
    if args.model == 'ONO2':
        model = ONO2(n_hidden=args.n_hidden, n_layers=args.n_layers, space_dim=1, n_head = args.n_heads, momentum=args.momentum, orth=args.orth, psi_dim=args.psi_dim, mlp_ratio=args.mlp_ratio, attn_type=args.attn_type).cuda()
    else:
    ...
    for ep in range(args.epochs):
        ...
        #if args.orth == 1:
            #print(model.blocks[-1].feature_cov)
        model.eval()
        rel_err = 0
